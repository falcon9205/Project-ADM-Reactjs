...
const Footer = () => {
  return (
    <>
       <footer className="bg-gray-500 text-center text-surface/75 dark:bg-gray-300 dark:text-black lg:text-left ">
        <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-gray-400 lg:justify-between">
          ...
          <div className="flex justify-center">
            <a href="https://www.facebook.com/profile.php?id=61550722756940&mibextid=ZbWKwL" className="me-6 [&>svg]:h-4 [&>svg]:w-4 ">
              <svg
            ...
            <a href="https://twitter.com/i/flow/login?redirect_after_login=%2FAdmeduWelfare" className="me-6 [&>svg]:h-4 [&>svg]:w-4 ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 512 512"
            ...
            <a href="https://www.instagram.com/admedu.society?igshid=MzRlODBiNWFlZA%3D%3D" className="me-6 [&>svg]:h-4 [&>svg]:w-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 448 512"
            ...
            <a href="https://www.linkedin.com/in/adm-education-and-welfare-society-45a06b27b/" className="me-6 [&>svg]:h-4 [&>svg]:w-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 448 512"
...
{/* Opening Hours */}
        ...
        <div className="bg-black/5 p-6 text-center font-bold">
          ...
          <a href="#/">
          Anita Devi Memorial Education and Welfare Society 
          </a>
        </div>
      </footer>
    </>
