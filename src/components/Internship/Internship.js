  ...
  return (
    <>
      <div className="container-fluid px-5 text-center  text-black">
        <div>
          <h2 className="title mt-5 border border-4 border-info">
            INTERNSHIP OPPORTUNITIES
          </h2>
          <p className=" para fs-4 text-center">
            {" "}
            Our internship opportunities cover a broad spectrum of fields to
            cater to the diverse talents and interests of our participants.
            These include:
          </p>
        </div>
            ...
            <Col xs={12} sm={6} md={6} lg={4} className="mb-5 card-animation">
              <Card className="patta">
                <Card.Img
                  className="card-img"
                  variant="top"
                  src="./assests/human resources.png"
                />
                <Card.Body>
            ...
            <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
              <Card className="patta">
                <Card.Img
                  variant="top"
                  className="card-img"
                  src="./assests/Graphic Designer.png"
                />
                <Card.Body>
            ...
            <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
              <Card className="patta">
                <Card.Img
                  variant="top"
                  className="card-img"
                  src="./assests/medical volunteer.png"
                />
                <Card.Body>
            ...
            <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
              <Card className="patta">
                <Card.Img
                  variant="top"
                  className="card-img"
                  src="./assests/ui-ux designer.png"
                />
                <Card.Body>
            ...
            <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
              <Card className="patta">
                <Card.Img
                  variant="top"
                  className="card-img"
                  src="./assests/campus ambassador.png"
                />
                <Card.Body>
            ...
            <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
              <Card className="patta">
                <Card.Img
                  variant="top"
                  className="card-img"
                  src="./assests/charity intern.png"
                />
                <Card.Body>
            ...
            <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
              <Card className="patta">
                <Card.Img
                  variant="top"
                  className="card-img"
                  src="./assests/full stack developer.png"
                />
                <Card.Body>
            ...
            <Col xs={12} sm={6} md={6} lg={4} className=" mb-5 card-animation">
              <Card className="patta">
                <Card.Img
                  variant="top"
                  className="card-img"
                  src="./assests/public relation.png"
                />
                <Card.Body>
        ...
        <p className=" footer-text card my-5   p-4 ">
          These internship roles are designed to empower students, housewives,
          and individuals from all backgrounds to develop valuable skills and
          gain practical experience. We believe in providing opportunities for
          personal growth and meaningful contributions to society.The
          certificates we distribute upon completion of these internships
          represent not only a milestone in your personal and professional
          journey but also your active role in shaping a brighter future for
          yourself and the community.Join us in this incredible journey of
          knowledge, growth, and empowerment, whether through our certificate
          programs or by participating in our dynamic internships. Your
          achievements and contributions are our inspiration, and together, we
          can work towards shaping a more educated, empowered, and capable
          world.
        </p>
      </div>
    </>
